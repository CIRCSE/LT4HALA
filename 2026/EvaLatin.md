...
- **New scorer** that calculates LAS and CLAS at subtype-level: [LINK to PYTHON SCRIPT](https://github.com/CIRCSE/LT4HALA/blob/master/2026/data_and_doc/conll18_ud_eval_with_subtypes-EvaLatin2026_modified.py)
