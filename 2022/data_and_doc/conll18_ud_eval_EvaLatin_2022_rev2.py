...
# This is revsion 2 of main scipt for evalatin 2022 camapign. This revision 
# provides a skiplist in order to not evaluate problematic tokens. To disable
# the skiplist set use_skipwords to False
...
# Skip words in evaluation process
SKIP_WORDS = {
	"aliquanto","aliquantum","aliquot","ambas","ambo","ambobus","amborum","ambos","bina","binae",
    "binas","binis","binorum","binos","bis","complura","decima","ducenta","duetuicensima","duodecima",
    "duodena","duodetriginta","duoetuicensima","duplicia","milia","multa","nona","nonaginta",
    "octaua","octingenta","octoginta","octona","pauca","pauciora","paucissima","plura","plurima","prima",
    "priora","quadraginta","quadringenta","quanta","quarta","quartadecima","quaterna","quina","quingenta",
    "quinquaginta","quinta","secunda","sena","septima","septingenta","septuaginta","sescenta","sexaginta",
    "sexcenta","sexta","singula","terna","tertia","trecenta","tria","tricena","tricesima","triginta",
    "trina","una","unaetuicensima","undecima","iu","u","ui","uii","uiii","uiiii","xu","xui",
    "xuii","xuiii","xxu","xxxu","xxxui","cccclxuiii","ccccuiii","ccccxcuiiii","ccclxxu","cclxxu","cuii",
    "cuiii","cxxu","cxxui","cxxxu","dcxxu","dxuiiii","lii.xu","lxu","lxuiiii","lxxuiii","lxxxix.xlu",
    "lxxxuii.d","lxxxu.lxxuiii","u","ui","uii","uii.d","uiii","uiiii","xcui","xcuiii.xuiii","xlui","xluiii",
    "xu","xui","xuii","xuiiii","xxu","xxui","xxuii","xxuiii","xxxui"
}
...
def load_conllu(file):
    ...
    while True:
        ...
        if (use_skipwords):
            if (columns[FORM].lower() in SKIP_WORDS):
                sentence_start -= 1
                continue
        ...
        if "-" in columns[ID]:
            ...
            for _ in range(start, end + 1):
                ...
                if (use_skipwords):
                    if (word_columns[FORM].lower() in SKIP_WORDS):
                        sentence_start -= 1
                        continue
        ...
        # Basic tokens/words
            ...
            # if use_skpiwords suppress id check
            #if (use_skipwords != True):
