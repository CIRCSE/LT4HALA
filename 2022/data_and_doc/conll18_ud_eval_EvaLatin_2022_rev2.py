...
SKIP_WORDS = {
	"aliquanto","aliquantum","aliquot","ambas","ambo","ambobus","amborum","ambos",
    "bina","binae","binas","binis","binorum","binos","bis","complura","decima","ducenta",
    "duetuicensima","duodecima","duodena","duodetriginta","duoetuicensima","duplicia","milia",
    "multa","nona","nonaginta","octaua","octingenta","octoginta","octona","pauca","pauciora",
    "paucissima","plura","plurima","prima","priora","quadraginta","quadringenta","quanta","quarta",
    "quartadecima","quaterna","quina","quingenta","quinquaginta","quinta","secunda","sena","septima",
    "septingenta","septuaginta","sescenta","sexaginta","sexcenta","sexta","singula","terna","tertia",
    "trecenta","tria","tricena","tricesima","triginta","trina","una","unaetuicensima","undecima"
}
    ...
    while True:
        ...
        if "-" in columns[ID]:
            ...
            for _ in range(start, end + 1):
                ...
                if (use_skipwords):
                    if (word_columns[FORM] in SKIP_WORDS):
                        sentence_start -= 1
                        continue
